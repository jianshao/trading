...
from ib_insync import Trade, Execution


from apis.api import BaseAPI, OrderUpdateCallback
from common.utils import GridOrder, OrderStatus, convert_trade_to_gridorder
...
class OrderManager:
    ...
    async def _dispatch_update(self, ib_trade: Trade):
        ...
        # --- 核心翻译逻辑 ---
        record.grid_order = convert_trade_to_gridorder(ib_trade)
